...
class TaskBasedTemporalUnet(nn.Module):

    def __init__(
            self, sequence_length, input_channels, out_channels, task_identity_dim=1, dim=128, dim_mults=(1, 2, 4, 8),
        ...
        print(f"downs:{len(self.downs)}, middle:{2}, ups:{len(self.ups)}, final:{1}")
    ...
    def forward(self, x, cond, timesteps, task_identity, use_dropout=True, force_dropout=False, **kwargs):
        '''
