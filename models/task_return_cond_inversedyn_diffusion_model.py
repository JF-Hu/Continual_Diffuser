...
class TaskReturnCondInverseDynamicGaussianDiffusion(nn.Module):
    ...
    def get_action(self, cond, data_shape, task_identity, ddim_sample, task_name, returns=0.95, *args, **kwargs):
        ...
        state_seq = self.conditional_sample(cond, data_shape, task_identity, ddim_sample, task_name=task_name, returns=returns, *args, **kwargs)
