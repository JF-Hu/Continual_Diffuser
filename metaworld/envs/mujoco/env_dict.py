...
'''
    CL10 environments and arguments
'''
CL10_HARD_MODE_CLS_DICT = OrderedDict((
    ('train',
        OrderedDict((
            ('push-v1', SawyerReachPushPickPlaceEnv),
            ('window-close-v1', SawyerWindowCloseEnv),
...
def _cl10_hard_mode_args_kwargs(env_cls_, key_):
    del env_cls_
...
CL10_HARD_MODE_ARGS_KWARGS = dict(train={}, test={})
for key, env_cls in CL10_HARD_MODE_CLS_DICT['train'].items():
    CL10_HARD_MODE_ARGS_KWARGS['train'][key] = _cl10_hard_mode_args_kwargs(env_cls, key)
for key, env_cls in CL10_HARD_MODE_CLS_DICT['test'].items():
    CL10_HARD_MODE_ARGS_KWARGS['test'][key] = _cl10_hard_mode_args_kwargs(env_cls, key)
