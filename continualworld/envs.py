...
import time
from continualworld.utils.wrappers import OneHotAdder, RandomizationWrapper, SuccessCounter, EnvVersionObsWrapper, TimeLimit, SuccessWrapper
...
# def get_cl10() -> metaworld_1.CL10:
#     saved_random_state = np.random.get_state()
#     np.random.seed(1)
#     CL10 = metaworld_1.CL10()
#     np.random.set_state(saved_random_state)
#     return CL10
...
# MT50_V1_TASK_NAMES = list(MT50_V1.train_classes)
MW_OBS_LEN = 12
MW_ACT_LEN = 4


def get_MT50_TASK_NAMES():
...
def get_cw_version2_env(
    ...
    env.name = task_name
    env = EnvVersionObsWrapper(env)
    env.unwrapped._partially_observable = False
